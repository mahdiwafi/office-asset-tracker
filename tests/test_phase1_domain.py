...
# [CP] Candidate-authored spec. Rules are enforced in the Day 2 service layer;
# xfail markers keep CI green until each rule goes live — remove them as they pass.
...
async def test_asset_creation_fails_if_inventory_tag_is_not_unique(
    ...
    first_asset = AssetCreate(inventory_tag='INV-001', name='Macbook', category_id=category.id)
