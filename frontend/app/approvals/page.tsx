		...
		<RequireAuth>
			<main className="mx-auto max-w-4xl px-4 py-8">
				<PageHeader
					...
					description="Pending requests and returns waiting for a decision."
				/>
				{error && (
				...
				{me && !APPROVER_ROLES.includes(me.role) && (
					<Alert tone="amber" title="Approver role required">
						<p className="text-amber-800">
							Only approvers can review requests and returns. Your role is{' '}
							<strong>{me.role}</strong> — ask an admin to grant you the Approver role in
							Entra ID if you need to.
						</p>
					</Alert>
				)}
				{me && APPROVER_ROLES.includes(me.role) && !pending && !returns && !error && (
				...
				{me &&
					...
					(pending.length === 0 && returns.length === 0 ? (
						<EmptyState
							...
							description="New requests and return requests will appear here."
