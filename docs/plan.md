...
| 1.0 | ✅ Ten-pair golden set (`docs/golden-set.md` + `scripts/golden_set.py`) — 7/7 answerable queries retrieved their expected article in a live run (2026-08-24), the four refusal rows exercised (near-miss, out-of-scope, floor). ADR 0005 records why probabilistic behaviour cannot be unit-tested: the hermetic suite proves wiring, the golden set is the manual quality tripwire. Outcome column is graded by hand on the deployed page. |
